...
func TestNewFromEnvDefaults(t *testing.T) {
	t.Setenv("wenxin2api_DEV_PACKET_CAPTURE_LIMIT", "")
	t.Setenv("wenxin2api_DEV_PACKET_CAPTURE_MAX_BODY_BYTES", "")
	t.Setenv("VERCEL", "")
	t.Setenv("NOW_REGION", "")
...
func TestNewFromEnvHonorsOverrides(t *testing.T) {
	t.Setenv("wenxin2api_DEV_PACKET_CAPTURE_LIMIT", "7")
	t.Setenv("wenxin2api_DEV_PACKET_CAPTURE_MAX_BODY_BYTES", "8192")
	t.Setenv("VERCEL", "")
	t.Setenv("NOW_REGION", "")
	s := NewFromEnv()
	if s.Limit() != 7 {
