...
func TestStoreSnapshotReturnsClone(t *testing.T) {
	t.Setenv("wenxin2api_CONFIG_JSON", `{"keys":["k1"],"accounts":[{"email":"u@test.com","token":"t1"}]}`)
	store := LoadStore()
	snap := store.Snapshot()
...
func TestStoreHasAPIKeyMultipleKeys(t *testing.T) {
	t.Setenv("wenxin2api_CONFIG_JSON", `{"keys":["key1","key2","key3"],"accounts":[]}`)
	store := LoadStore()
...
func TestStoreFindAccountNotFound(t *testing.T) {
	t.Setenv("wenxin2api_CONFIG_JSON", `{"keys":["k1"],"accounts":[{"email":"u@test.com"}]}`)
	store := LoadStore()
...
func TestStoreIgnoresRemovedCompatConfig(t *testing.T) {
	t.Setenv("wenxin2api_CONFIG_JSON", `{"keys":["k1"],"accounts":[],"compat":{"strip_reference_markers":false}}`)
	store := LoadStore()
...
func TestStoreIsEnvBacked(t *testing.T) {
	t.Setenv("wenxin2api_CONFIG_JSON", `{"keys":["k1"],"accounts":[]}`)
	store := LoadStore()
...
func TestStoreModelAliasesIncludesDefaultsAndOverrides(t *testing.T) {
	t.Setenv("wenxin2api_CONFIG_JSON", `{"keys":[],"accounts":[],"model_aliases":{"claude-opus-4-6":"deepseek-v4-pro-search"}}`)
	store := LoadStore()
...
func TestStoreModelAliasesDefault(t *testing.T) {
	t.Setenv("wenxin2api_CONFIG_JSON", `{"keys":[],"accounts":[]}`)
	store := LoadStore()
	aliases := store.ModelAliases()
	if aliases == nil {
...
func TestStoreExportJSONAndBase64(t *testing.T) {
	t.Setenv("wenxin2api_CONFIG_JSON", `{"keys":["export-key"],"accounts":[]}`)
	store := LoadStore()
