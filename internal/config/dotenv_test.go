...
func TestLoadDotEnvLoadsWorkingDirectoryFileWithoutOverridingExistingEnv(t *testing.T) {
	...
	const newKey = "wenxin2api_TEST_DOTENV_NEW"
	const keepKey = "wenxin2api_TEST_DOTENV_KEEP"
	const quotedKey = "wenxin2api_TEST_DOTENV_QUOTED"

	unsetEnv(t, newKey)
	unsetEnv(t, quotedKey)
	t.Setenv(keepKey, "from-env")

	content := "wenxin2api_TEST_DOTENV_NEW=from-file\n" +
		"wenxin2api_TEST_DOTENV_KEEP=from-file\n" +
		"wenxin2api_TEST_DOTENV_QUOTED=\"line1\\nline2\"\n"
...
func TestLoadDotEnvStripsInlineCommentsFromUnquotedValues(t *testing.T) {
	...
	const plainKey = "wenxin2api_TEST_DOTENV_PLAIN"
	const hashKey = "wenxin2api_TEST_DOTENV_HASH"
	const quotedKey = "wenxin2api_TEST_DOTENV_QUOTED_COMMENT"
	const exportKey = "wenxin2api_TEST_DOTENV_EXPORT"
