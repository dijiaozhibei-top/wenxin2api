...
var wenxinBaseModels = []ModelInfo{
	{ID: "deepseek-v4-pro", Object: "model", Created: 1748534400, OwnedBy: "wenxin", Permission: []any{}},
	{ID: "deepseek-r1", Object: "model", Created: 1748534400, OwnedBy: "wenxin", Permission: []any{}},
	{ID: "smartmode", Object: "model", Created: 1748534400, OwnedBy: "wenxin", Permission: []any{}},
	{ID: "smartmode-thinking", Object: "model", Created: 1748534400, OwnedBy: "wenxin", Permission: []any{}},
	{ID: "ernie-4.5-turbo", Object: "model", Created: 1748534400, OwnedBy: "wenxin", Permission: []any{}},
}

var OllamaCapabilitiesModels = []OllamaCapabilitiesModelInfo{
	{ID: "ernie-4.5-turbo", Capabilities: []string{"tools"}},
	{ID: "deepseek-v4-pro", Capabilities: []string{"tools", "thinking"}},
	{ID: "deepseek-r1", Capabilities: []string{"tools", "thinking"}},
	{ID: "smartmode", Capabilities: []string{"tools"}},
	{ID: "smartmode-thinking", Capabilities: []string{"tools", "thinking"}},
}

var DeepSeekModels = wenxinBaseModels
...
func GetModelConfig(model string) (thinking bool, search bool, ok bool) {
	...
	switch baseModel {
	case "ernie-4.5-turbo", "deepseek-v4-pro", "deepseek-r1", "smartmode":
...
func GetModelType(model string) (modelType string, ok bool) {
	...
	switch baseModel {
	case "ernie-4.5-turbo", "deepseek-v4-pro", "deepseek-r1", "smartmode", "smartmode-thinking":
		return "default", true
	default:
		return "", false
	}
...
func DefaultModelAliases() map[string]string {
	return map[string]string{
		// OpenAI GPT / ChatGPT families → deepseek-v4 (Wenxin Search-Lightning)
		"chatgpt-4o":          "deepseek-v4",
		"gpt-4":               "deepseek-v4",
		"gpt-4-turbo":         "deepseek-v4",
		"gpt-4-turbo-preview": "deepseek-v4",
		"gpt-4.5-preview":     "deepseek-v4",
		"gpt-4o":              "deepseek-v4",
		"gpt-4o-mini":         "deepseek-v4",
		"gpt-4.1":             "deepseek-v4",
		"gpt-4.1-mini":        "deepseek-v4",
		"gpt-4.1-nano":        "deepseek-v4",
		"gpt-5":               "deepseek-v4",
		"gpt-5-chat":          "deepseek-v4",
		"gpt-5.1":             "deepseek-v4",
		"gpt-5.1-chat":        "deepseek-v4",
		"gpt-5.2":             "deepseek-v4",
		"gpt-5.2-chat":        "deepseek-v4",
		"gpt-5.3-chat":        "deepseek-v4",
		"gpt-5.4":             "deepseek-v4",
		"gpt-5.5":             "deepseek-v4",
		"gpt-5-mini":          "deepseek-v4",
		...
		"claude-sonnet-4-5-20250929": "deepseek-v4",
		"claude-sonnet-4-0":          "deepseek-v4",
		"claude-sonnet-4-20250514":   "deepseek-v4",
		"claude-haiku-4-5":           "deepseek-v4",
		"claude-haiku-4-5-20251001":  "deepseek-v4",
		"claude-3-7-sonnet":          "deepseek-v4",
		"claude-3-7-sonnet-latest":   "deepseek-v4",
		"claude-3-7-sonnet-20250219": "deepseek-v4",
		"claude-3-5-sonnet":          "deepseek-v4",
		"claude-3-5-sonnet-latest":   "deepseek-v4",
		"claude-3-5-sonnet-20240620": "deepseek-v4",
		"claude-3-5-sonnet-20241022": "deepseek-v4",
		"claude-3-5-haiku":           "deepseek-v4",
		"claude-3-5-haiku-latest":    "deepseek-v4",
		"claude-3-5-haiku-20241022":  "deepseek-v4",
		"claude-3-opus":              "deepseek-v4-pro",
		"claude-3-opus-20240229":     "deepseek-v4-pro",
		"claude-3-sonnet":            "deepseek-v4",
		"claude-3-sonnet-20240229":   "deepseek-v4",
		"claude-3-haiku":             "deepseek-v4",
		"claude-3-haiku-20240307":    "deepseek-v4",

		// Gemini current and historical text / multimodal models
		"gemini-pro":            "deepseek-v4-pro",
		"gemini-pro-latest":     "deepseek-v4-pro",
		"gemini-flash-latest":   "deepseek-v4",
		"gemini-1.5-pro":        "deepseek-v4-pro",
		"gemini-1.5-flash":      "deepseek-v4",
		"gemini-1.5-flash-8b":   "deepseek-v4",
		"gemini-2.0-flash":      "deepseek-v4",
		"gemini-2.0-flash-lite": "deepseek-v4",
		"gemini-2.5-pro":        "deepseek-v4-pro",
		"gemini-2.5-flash":      "deepseek-v4",
		"gemini-2.5-flash-lite": "deepseek-v4",
		"gemini-3.1-pro":        "deepseek-v4-pro",
		"gemini-3-pro":          "deepseek-v4-pro",
		"gemini-3-flash":        "deepseek-v4",
		"gemini-3.1-flash":      "deepseek-v4",
		"gemini-3.1-flash-lite": "deepseek-v4",

		"llama-3.1-70b-instruct": "deepseek-v4",
		"qwen-max":               "deepseek-v4",
	}
}
