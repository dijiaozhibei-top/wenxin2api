...
function internalSecret() {
  return asString(process.env.wenxin2api_VERCEL_INTERNAL_SECRET) || asString(process.env.wenxin2api_ADMIN_KEY) || 'admin';
}
...
function resolveProtectionBypass(req) {
  ...
  return asString(process.env.VERCEL_AUTOMATION_BYPASS_SECRET) || asString(process.env.wenxin2api_VERCEL_PROTECTION_BYPASS);
}
