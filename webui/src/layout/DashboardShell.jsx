...
function TabLoadingFallback({ label }) {
    return (
        <div className="min-h-[320px] rounded-lg border border-border bg-white/90 backdrop-blur flex items-center justify-center">
    ...
    return (
        <div className="flex h-screen bg-background overflow-hidden text-foreground">
            ...
            <aside className={clsx(
                "fixed lg:static inset-y-0 left-0 z-50 w-52 bg-white/90 backdrop-blur border-r border-border transition-transform duration-300 ease-in-out lg:transform-none flex flex-col shadow-2xl lg:shadow-none",
                    ...
                    {navItems.map((item) => {
                        ...
                        return (
                            <button
                                ...
                                className={clsx(
                                    "w-full flex items-center gap-4 px-4 py-2.5 rounded-lg text-sm font-medium transition-all duration-200 group border",
                                    isActive
                ...
                <div className="p-4 border-t border-border bg-white/90 backdrop-blur">
                        ...
                        <div className="bg-background rounded-lg p-4 border border-border shadow-sm">
                            ...
                            {versionInfo?.has_update && (
                                <a
                                    ...
                                    href={versionInfo?.release_url || 'https://github.com/dijiaozhibei-top/wenxin2api/releases/latest'}
                                    target="_blank"
                                    rel="noreferrer"
                                >
            ...
            <main className="flex-1 flex flex-col min-w-0 overflow-hidden relative">
                <header className="lg:hidden h-14 flex items-center justify-between px-4 border-b border-border bg-white/90 backdrop-blur">
                    <div className="flex items-center gap-2">
                        ...
                        <span className="font-semibold text-sm">Wenxin2API</span>
                    </div>
                    <div className="flex items-center gap-2">
                        <LanguageToggle />
                        <button
                ...
                <div className="flex-1 overflow-auto bg-background p-4 lg:p-10">
                    <div className="max-w-6xl mx-auto space-y-4 lg:space-y-6">
                        ...
                        {message && (
                            <div className={clsx(
                                "p-4 rounded-lg border flex items-center gap-4 animate-in fade-in slide-in-from-top-2",
