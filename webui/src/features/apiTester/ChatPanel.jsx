        ...
        <div className="lg:col-span-9 flex flex-col bg-card border border-border rounded-xl shadow-sm overflow-hidden min-h-0 flex-1 relative">
            ...
            <div className="p-4 lg:p-6 border-t border-border bg-card">
                ...
                <div className="max-w-4xl mx-auto relative group">
                    ...
                    <textarea
                        className="w-full bg-background border border-border rounded-xl pl-12 pr-12 py-3 text-sm focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all resize-none custom-scrollbar placeholder:text-muted-foreground/50 text-foreground disabled:opacity-60 disabled:cursor-not-allowed"
