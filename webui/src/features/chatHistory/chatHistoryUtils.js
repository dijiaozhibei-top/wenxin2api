...
export const VIEW_MODE_KEY = 'wenxin2api_chat_history_view_mode'
...
const CURRENT_INPUT_FILE_PROMPT = 'Continue from the latest state in the attached wenxin2api_HISTORY.txt context. Treat it as the current working state and answer the latest user request directly.'
...
const HISTORY_TRANSCRIPT_TITLE = '# wenxin2api_HISTORY.txt'
