            ...
            <div className="rounded-2xl border border-border bg-card shadow-sm p-4 lg:p-5 flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                ...
                <div className="flex flex-wrap gap-2 items-center">
                    ...
                    <button
                        ...
                        className="h-10 w-10 rounded-xl border border-border bg-secondary text-muted-foreground hover:text-destructive hover:bg-muted disabled:opacity-50 flex items-center justify-center"
