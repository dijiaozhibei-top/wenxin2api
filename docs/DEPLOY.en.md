...
The default `docker-compose.yml` directly uses `ghcr.io/cjackhwang/wenxin2api:latest` and maps host port `6011` to container port `5001`. If you want `5001` exposed directly, set `wenxin2api_HOST_PORT=5001` (or adjust the `ports` mapping).
