# wenxin2api Architecture & Project Layout
...
│   ├── wenxin2api/                           # Main service bootstrap
│   └── wenxin2api-tests/                     # E2E testsuite CLI bootstrap
...
- On first local startup, if `static/admin` is missing, wenxin2api may auto-build it (Node.js required).
